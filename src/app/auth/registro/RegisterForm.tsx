            ...
            <div className="max-w-md w-full space-y-8 p-10 bg-white rounded-xl z-10">
                ...
                <form className="mt-8 space-y-6" action="#" method="POST">
                    ...
                    <div className="mt-8 content-center">
                        ...
                        <input className="w-full content-center text-base py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="password" placeholder="Repetir password" />
                    </div>
